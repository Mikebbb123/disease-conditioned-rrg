...
def main():
    ...
    # output_dir gets a _seed{N} suffix so each seed writes best.pt / history.json /
    # test_final.json into its own folder (read these per-seed for mean±std).
    ...
    train_cfg.output_dir = f"{train_cfg.output_dir}_seed{train_cfg.seed}"
